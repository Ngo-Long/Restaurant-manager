...
import static restaurant.onsite.AreaKitchen.DETAIL_ID_COLUMN_INDEX;

public class AreaKitchen extends javax.swing.JPanel {

    private OnSiteMode onSite;

    public AreaKitchen(OnSiteMode onSite) {
        this.onSite = onSite;
        initComponents();
        this.init();
    }
    ...
    private void btnResetActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnResetActionPerformed
        onSite.displayOnSitePanel(new AreaKitchen(onSite));
    ...
    void init() {
        ...
        List<OrderDetailEntity> dataList = new OrderDetailDAO().getPendingProducts();
        this.fillTable(dataList, tablePending);
    }

    void fillTable(List<OrderDetailEntity> dataList, JTable tableMain) {
        try {
            // Get model
