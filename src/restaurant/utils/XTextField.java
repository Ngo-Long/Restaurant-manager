...
public class XTextField {
    ...
    public static void addFocusBorder(JComponent component, Color focusColor, Color unfocusColor) {
        ...
        // Tạo viền kết hợp với padding right
     ...
     */
    public static String addCommasToNumber(long num) {
        return addCommasToNumber(Long.toString(num));
    }

    public static String addCommasToNumber(int num) {
        return addCommasToNumber(Integer.toString(num));
    }
