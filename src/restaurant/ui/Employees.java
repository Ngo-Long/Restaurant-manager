...
public class Employees extends javax.swing.JFrame {
    ...
    public Employees(Map<String, String> userInfo) {
        initComponents();
        ...
        Common.customizeTable(tableListEmplyees, new int[]{1});
        ...
        ((DefaultTableModel) tableListEmplyees.getModel()).addTableModelListener(e -> updateTongNhanVien());
        tableListEmplyees.setRowSelectionInterval(currentIndex, currentIndex);
    }
    ...
    private void addTableMouseListener() {
        tableListEmplyees.addMouseListener(new MouseAdapter() {
            @Override
    ...
    private void updateTongNhanVien() {
        int rowCount = tableListEmplyees.getRowCount();
    ...
    private void displayEmployeeDetails(int selectedRow) {
        ...
        String idNhanVien = tableListEmplyees.getValueAt(selectedRow, 0).toString();
    ...
    private void initComponents() {
        ...
        if (tableListEmplyees.getColumnModel().getColumnCount() > 0) {
            tableListEmplyees.getColumnModel().getColumn(0).setPreferredWidth(50);
            tableListEmplyees.getColumnModel().getColumn(1).setPreferredWidth(130);
        }
    ...
    private void btnPreActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPreActionPerformed
        ...
        if (currentIndex >= tableListEmplyees.getRowCount()) {
            currentIndex = tableListEmplyees.getRowCount() - 1;
        }
