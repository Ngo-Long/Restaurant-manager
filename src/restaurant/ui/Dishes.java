...
public class Dishes extends javax.swing.JFrame {
    ...
    private List<DishEntity> foodList;
    ...
    private void displayMenuItems() {
        ...
        for (DishEntity foodItem : foodList) {
            JPanel btnFood = createFoodPanel(foodItem);
            panelMenu.add(btnFood);
        }
    }

    private JPanel createFoodPanel(DishEntity foodItem) {
        // Get URL image
    ...
    private void handleOrder(DishEntity foodItem) {
    ...
    private void displayDetailedInfo(DishEntity foodItem) {
