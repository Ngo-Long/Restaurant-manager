...
public final class Supplier extends javax.swing.JPanel {
    ...
    public Supplier(ManagementMode managementMode) {
        initComponents();
    ...
    private void btnExportActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExportActionPerformed
        exportToExcel(tableGoods, "Nhà cung cấp");
    }//GEN-LAST:event_btnExportActionPerformed

    private void btnImportActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImportActionPerformed
        MessageFormat header = new MessageFormat("Danh sách nhà cung cấp");
    ...
    public void fillTable(List<SupplierEntity> dataList) {
        ...
        for (SupplierEntity dataItem : dataList) {
            model.addRow(new Object[]{
                ...
                dataItem.getEmail(),
                dataItem.getAddress(),
                dataItem.getOutstandingDebt(),
                dataItem.getTotalSales()
            });
        }
    }
    // end --->
