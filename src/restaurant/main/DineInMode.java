...
import restaurant.dinein.Overview;
import restaurant.dinein.Products;
import restaurant.dinein.Invoices;
import restaurant.dinein.DiningTable;
import restaurant.dinein.KitchenArea;

public final class DineInMode extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DineInMode.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }

        java.awt.EventQueue.invokeLater(() -> {
            new DineInMode().setVisible(true);
        });
    }
