...
public final class MainManager extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        labelLogo.setFont(new java.awt.Font("Segoe UI", 3, 26)); // NOI18N
        ...
        jMenu3.setText("Vai trò");

        jMenuItem2.setText("Phục vụ");
        jMenu3.add(jMenuItem2);

        jMenuItem3.setText("Thu ngân");
        jMenu3.add(jMenuItem3);

        jMenuItem4.setText("Đầu bếp");
        jMenu3.add(jMenuItem4);

        jMenuItem5.setText("Quản lý");
    ...
    private void menuTablesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuTablesActionPerformed
        displayManagerPanels(new DiningTables(this));
...
//        displayPanels(new Overview(this));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            MainManager overviewFrame = new MainManager();
