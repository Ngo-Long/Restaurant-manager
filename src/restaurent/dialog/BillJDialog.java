...
public class BillJDialog extends javax.swing.JDialog {
    ...
    void bill() {
        ...
        int index = 1;
        List<OrderDetailsEntity> dataDetails = Auth.orderDetails;

        for (OrderDetailsEntity dataDetail : dataDetails) {
            // Trả về món ăn
            ProductsEntity dataProduct = new ProductsDAO().getById(dataDetail.getProductID());
