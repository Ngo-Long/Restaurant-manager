...
import static DAO.TaiKhoanDAO.isIdNhanVienExists;
import static DAO.TaiKhoanDAO.searchAndClassifyEmployee;
...
public class TaiKhoan extends javax.swing.JFrame {
    ...
    private void addAccount() {
        ...
        TaiKhoanDAO.insertAccount(idTaiKhoan, idNhanVien, taiKhoan, matKhau);
...
//    }
    ...
    private void displayCurrentEmployee(int index) {
        if (index >= 0 && index < employeeList.size()) {
            ...
            TaiKhoanEntity taiKhoanEntity = employee.getTaiKhoanEntity();
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                            ...
                                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                                .addComponent(textMatKhau, javax.swing.GroupLayout.Alignment.LEADING)
                                                .addComponent(textTaiKhoan, javax.swing.GroupLayout.Alignment.LEADING)
                                                .addGroup(layout.createSequentialGroup()
                                                    .addComponent(textNgayTao, javax.swing.GroupLayout.DEFAULT_SIZE, 283, Short.MAX_VALUE)
                                                    .addGap(1, 1, 1))))))
                                .addGap(29, 29, 29))))
...
//        }
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        TaiKhoanDAO.updateAccount(idTaiKhoan, taiKhoan, matKhau);
        loadDataIntoTable();
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        TaiKhoanDAO.deleteAccount(idNhanVien);
        loadDataIntoTable();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            ...
            TaiKhoan tk = new TaiKhoan(userInfo);
